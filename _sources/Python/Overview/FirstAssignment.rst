...
.. topic:: Quick Overview of Day
    ...
    Go over practice problems from last day. Introduce the first Python assignment.
...
You might want to look back at the :ref:`math_operator_list` if you forget what one of the operators below is for.

.. note:: Your teacher may choose to use the following examples as a class activity, by displaying the  examples, and having you take a guess as to what you think each will do before running the code. 

What will the following programs output? Why?

Use ``x = 42`` and ``x = 43`` in the code below. What will the program print in each of case?

.. activecode:: wdtpd_first_assn_1
    :caption: What will this program print?
    :nocodelens:

    x = 42
    if x % 2 == 0:
      print("I am so getting even...")


Use ``x = 42``, ``x = 142`` and ``x = 2`` in the code below. What will the program print in each of these cases?

.. activecode:: wdtpd_first_assn_2
    :caption: What will this program print?
    :nocodelens:
