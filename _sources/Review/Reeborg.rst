...
.. |apple_pie_world| raw:: html
   ...
   <a href="/reeborg?lang=en&mode=python&url=worlds/sk/apple-pie.json&name=ApplePie" target="_blank">Apple Pie world</a>
...
.. |origin_world| raw:: html
   ...
   <a href="/reeborg?lang=en&mode=python&url=worlds/sk/goToOrigin.json&name=GoToOrigin" target="_blank">Go To Origin Review world</a>
...
.. |hurdle_world| raw:: html
   ...
   <a href="/reeborg?lang=en&mode=python&url=worlds/sk/hurdle.json&name=HurdleReview" target="_blank">Hurdle Jump Review World</a>
...
.. |planting_time_world| raw:: html
   ...
   <a href="/reeborg?lang=en&mode=python&url=worlds/sk/planting-time.json&name=PlantingTime" target="_blank">Planting Time world</a>
